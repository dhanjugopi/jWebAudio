...
jWebAudio.SoundEngine.prototype={addSoundSource:function(a){if("object"!==typeof a||!a.hasOwnProperty("url"))console.error("Error url in addSoundSource.");else{!0!==a.preLoad&&(a.preLoad=!1);"function"!==typeof a.callback&&"object"!==typeof a.callback&&(a.callback=null);!0!==a.multishot&&(a.multishot=!1);if("string"===typeof a.url)return this.soundArray.push(new jWebAudio.SoundSource(this.soundArray.length,a)),this.soundArray[this.soundArray.length-1];if("object"===typeof a.url){if(a.preLoad){var c=
a.url.length,e=0,f=a.callback;a.callback=function(){++e;e===c&&f&&f()}}var d=this.soundArray.length,g=a.url.slice(),b;for(b in a.url)a.url=g[b],this.soundArray.push(new jWebAudio.SoundSource(this.soundArray.length,a));a=[];for(b=d;b<this.soundArray.length;++b)a[b-d]=this.soundArray[b];return a}}},destroySound:function(a){this.soundArray[a]&&(this.soundArray[a].isLoaded&&this.soundArray[a].stop(),delete this.soundArray[a])}};
...
jWebAudio.WebAudioSound=function(a,c){function e(){var a=l.duration-h;k=g.createBufferSource();k.buffer=l;k.loop=d.options.loop;k.connect(b);d.options.fadeIn&&(b.gain.setValueAtTime(b.gain.minValue,g.currentTime),b.gain.linearRampToValueAtTime(b.gain.maxValue,g.currentTime+d.options.fadeInTime));k.noteGrainOn(0,h,a);m=g.currentTime;j=d.PLAYING;n=setTimeout(function(){!0===d.options.loop?d.seek(0):(h=0,j=d.STOPPED);c&&c()},1E3*a);!0===d.options.fadeOut&&(p=setTimeout(function(){b.gain.setValueAtTime(b.gain.maxValue,
g.currentTime);b.gain.linearRampToValueAtTime(b.gain.minValue,g.currentTime+d.options.fadeOutTime)},1E3*(a-d.options.fadeOutTime)))}function f(){j===d.PLAYING&&(k.noteOff(0),k=null,h+=g.currentTime-m,clearTimeout(n),clearTimeout(p))}jWebAudio.Sound.call(this);var d=this,g=jWebAudio.context,b=g.createGainNode();b.connect(d.gain);var k=null,l=a;this.__defineGetter__("duration",function(){return l.duration});var h=0;this.__defineGetter__("offset",function(){return j===d.PLAYING?g.currentTime-m+h:h});
this.seek=function(a){if("number"!==typeof a||0>a||a>l.duration)console.error("Error arg in WebAudioSound.");else{var b=j;f();h=a;b===this.PLAYING&&e()}};var m=0,j=this.STOPPED;this.__defineGetter__("state",function(){return j});var n=null,p=null;this.play=function(){j!==d.PLAYING&&e()};this.pause=function(){j===d.PLAYING&&(f(),j=d.PAUSED)};this.stop=function(){if(j!==d.STOPPED)if(d.options.fadeOut){var a=d.options.fadeOutTime;b.gain.linearRampToValueAtTime(b.gain.minValue,g.currentTime+a);setTimeout(function(){f();
h=0;j=d.STOPPED},1E3*a)}else f(),h=0,j=d.STOPPED};this.setFadeIn=function(a,b){"boolean"===typeof a?(d.options.fadeIn=a,"number"===typeof b&&(d.options.fadeInTime=b)):(d.options.fadeOut=ifFadeOut,console.error("Error type in setFadeIn."))};this.setFadeOut=function(a,b){"boolean"===typeof a&&"number"===typeof b&&(d.options.fadeOutTime=b)}};jWebAudio.extend(jWebAudio.WebAudioSound,jWebAudio.Sound);
jWebAudio.WebAudioMultishotSound=function(a){jWebAudio.Sound.call(this);var c=jWebAudio.context,e=[],f=this;this.play=function(){var d=c.createBufferSource();d.buffer=a;d.loop=this.loop;d.connect(f.gain);d.noteOn(0);e.push(d)};this.stop=function(){e.forEach(function(a){a.noteOff(0);a.disconnect()});e=[]}};jWebAudio.extend(jWebAudio.WebAudioMultishotSound,jWebAudio.Sound);
...
jWebAudio.Filter=function(a,c){this.getName=function(){return a};var e,f;f=[];var d,g,b=[];if(c instanceof Array)f=c;else if(c instanceof Object)f.push(c);else return;var k=jWebAudio.context;for(e=0;e<f.length;++e)d=f[e],0<=d.type&&7>=d.type&&(g=k.createBiquadFilter(),g.type=d.type,g.frequency.value=d.frequency,g.Q.value=d.Q,g.gain.value=d.gain,b.push(g));for(e=0;e<b.length-1;++e)f=e+1,b[e].connect(b[f]);this.__defineGetter__("inNode",function(){return b[0]});this.__defineGetter__("outNode",function(){return b[b.length-
